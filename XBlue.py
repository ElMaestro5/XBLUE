...
def mainT(url):
        ...
        try:
                ...
                if payload in str(respData):
                        print(colored.green('the payload is reflected on this page ... the site is potentially XSS vulnerable'))
...
f = Figlet(font='slant')
print(colored.yellow(f.renderText('XBlue')))
